            ...
            <header class="block">
                <ul class="header-menu horizontal-list">
                    ...
                    <li>
                     ...
                     <li>
                        <a class="header-menu-tab" href="HomeModel.jsp"><span class="icon fontawesome-home scnd-font-color"></span>Model</a>
                    </li>
                </ul>
                <div class="profile-menu">
                    <p>Me <a href="#26"><span class="entypo-down-open scnd-font-color"></span></a></p>
                    <div class="profile-picture small-profile-picture">
                        <img width="40px" alt="Salil picture" src="img/IMG_20170215_010057_E.jpg">
                    </div>
                </div>
            </header>
            ...
            <div class="middle-container container">
                <div class="profile block"> <!-- PROFILE (MIDDLE-CONTAINER) -->
                    ...
                    <div class="profile-picture big-profile-picture clear">
                        <img width="150px" alt="Salil picture" src="img/IMG_20170215_010057_E.jpg" >
                    </div>
                    <h1 class="user-name">Salil Kumar Jain</h1>
                    <div class="profile-description">
                        <p class="scnd-font-color">ITA/Architect/Designer @ TCS</p>
                    </div>
